...
// rootPath:
//
//     ./.certmanager/accounts/
//          │      └── root accounts directory
//          └── "path" option
//
// rootUserPath:
//
//     ./.certmanager/accounts/localhost_14000/hubert@hubert.com/
//          │      │             │             └── userID ("email" option)
...
// keysPath:
//
//     ./.certmanager/accounts/localhost_14000/hubert@hubert.com/keys/
//          │      │             │             │           └── root keys directory
//          │      │             │             └── userID ("email" option)
//          │      │             └── CA server ("server" option)
//          │      └── root accounts directory
...
// accountFilePath:
//
//     ./.certmanager/accounts/localhost_14000/hubert@hubert.com/account.json
//          │      │             │             │             └── account file
//          │      │             │             └── userID ("email" option)
//          │      │             └── CA server ("server" option)
//          │      └── root accounts directory
...
func tryRecoverRegistration(ctx *cli.Context, privateKey crypto.PrivateKey) (*registration.Resource, error) {
	...
	config := certmanager.NewConfig(&Account{key: privateKey})
