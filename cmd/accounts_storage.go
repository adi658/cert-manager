...
// rootPath:
//
//     ./.cert-manager/accounts/
//          │      └── root accounts directory
//          └── "path" option
//
// rootUserPath:
//
//     ./.cert-manager/accounts/localhost_14000/hubert@hubert.com/
//          │      │             │             └── userID ("email" option)
...
// keysPath:
//
//     ./.cert-manager/accounts/localhost_14000/hubert@hubert.com/keys/
//          │      │             │             │           └── root keys directory
//          │      │             │             └── userID ("email" option)
//          │      │             └── CA server ("server" option)
//          │      └── root accounts directory
...
// accountFilePath:
//
//     ./.cert-manager/accounts/localhost_14000/hubert@hubert.com/account.json
//          │      │             │             │             └── account file
//          │      │             │             └── userID ("email" option)
//          │      │             └── CA server ("server" option)
//          │      └── root accounts directory
...
func tryRecoverRegistration(ctx *cli.Context, privateKey crypto.PrivateKey) (*registration.Resource, error) {
	...
	config := cert-manager.NewConfig(&Account{key: privateKey})
