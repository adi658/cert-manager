...
import (
	...
	"github.com/adi658/certmanager/certmanager"
...
func renewForDomains(ctx *cli.Context, client *certmanager.Client, certsStorage *CertificatesStorage, bundle bool) error {
...
func renewForCSR(ctx *cli.Context, client *certmanager.Client, certsStorage *CertificatesStorage, bundle bool) error {
