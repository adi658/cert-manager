...
func renewForDomains(ctx *cli.Context, client *cert-manager.Client, certsStorage *CertificatesStorage, bundle bool) error {
...
func renewForCSR(ctx *cli.Context, client *cert-manager.Client, certsStorage *CertificatesStorage, bundle bool) error {
