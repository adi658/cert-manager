...
import (
	...
	"github.com/adi658/cert-manager/providers/http/webroot"
	"github.com/urfave/cli"
)

func setupChallenges(ctx *cli.Context, client *cert-manager.Client) {
...
func setupDNS(ctx *cli.Context, client *cert-manager.Client) {
