...
func createRun() cli.Command {
	return cli.Command{
		...
		Flags: []cli.Flag{
			...
			cli.BoolFlag{
				Name:  "must-staple",
				Usage: "Include the OCSP must staple TLS extension in the CSR and generated certificate. Only works if the CSR is generated by cert-manager.",
			},
		},
	}
}
...
func handleTOS(ctx *cli.Context, client *cert-manager.Client) bool {
...
func register(ctx *cli.Context, client *cert-manager.Client) (*registration.Resource, error) {
...
func obtainCertificate(ctx *cli.Context, client *cert-manager.Client) (*certificate.Resource, error) {
