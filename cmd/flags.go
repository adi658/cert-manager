...
func CreateFlags(defaultPath string) []cli.Flag {
	return []cli.Flag{
		...
		cli.StringFlag{
			...
			Value: cert-manager.LEDirectoryProduction,
		},
		cli.BoolFlag{
			Name:  "accept-tos, a",
		...
		cli.StringFlag{
			Name:  "dns",
			Usage: "Solve a DNS challenge using the specified provider. Can be mixed with other types of challenges. Run 'cert-manager dnshelp' for help on usage.",
		},
		cli.BoolFlag{
			Name:  "dns.disable-cp",
