...
func TestDNSProvider_buildQuery(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			domain:   "domain",
			txt:      "TXTtxtTXT",
			expected: "https://api.dreamhost.com?cmd=dns-add_record&comment=Managed%2BBy%2Bcert-manager&format=json&key=asdf1234&record=domain&type=TXT&value=TXTtxtTXT",
		},
		{
