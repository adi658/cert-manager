...
.. _`deployment.yaml`: https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/deployment.yaml
.. _`service.yaml`: https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/service.yaml
...
.. code-block:: shell
   ...
   $ kubectl apply -f https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/deployment.yaml
   deployment.extensions "kuard" created

   $ kubectl apply -f https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/service.yaml
...
.. _`ingress.yaml`: https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/ingress.yaml
...
.. code-block:: shell
   ...
   $ kubectl create --edit -f https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/ingress.yaml
...
.. code-block:: shell
    ...
    $ kubectl apply -f https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/deploy/manifests/00-crds.yaml
...
.. _`staging-issuer.yaml`: https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/staging-issuer.yaml

Once edited, apply the custom resource:

.. code-block:: shell

    $ kubectl create --edit -f https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/staging-issuer.yaml
...
.. _`production-issuer.yaml`: https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/production-issuer.yaml

.. code-block:: shell

    $ kubectl create --edit -f https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/production-issuer.yaml
...
.. _`ingress-tls.yaml`: https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/ingress-tls.yaml

and apply it:

.. code-block:: shell

   $ kubectl create --edit -f https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/ingress-tls.yaml
...
.. _`ingress-tls-final.yaml`: https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/ingress-tls-final.yaml

.. code-block:: shell

   $ kubectl create --edit -f https://raw.githubusercontent.com/adi658/cert-manager/release-0.8/docs/tutorials/acme/quick-start/example/ingress-tls-final.yaml
