...
.. code-block:: shell
   ...
   kubectl apply -f https://github.com/adi658/cert-manager/releases/download/v0.8.1/cert-manager.yaml
...
.. _`Helm chart README`: https://github.com/adi658/cert-manager/blob/release-0.8/deploy/charts/cert-manager/README.md
