...
import (
	...
	"github.com/adi658/cert-manager/acme/api/internal/nonces"
	"github.com/adi658/cert-manager/acme/api/internal/sender"
...
func TestNotHoldingLockWhileMakingHTTPRequests(t *testing.T) {
	...
	doer := sender.NewDoer(http.DefaultClient, "cert-manager-test")
